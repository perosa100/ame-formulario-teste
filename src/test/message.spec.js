...
describe('Message Component', () => {
  it('should render Message with no header and empty content', () => {
    ...
    expect(
      wrapper.find('.message-header').exists(),
      '.message-header should not be rendered when no header given'
    ).to.be.false
  })
  it('should render Message with header when `header` prop was provided', () => {
    ...
    expect(
      wrapper.find('.message-header').exists(),
      '.message-header should be rendered when header prop given'
    ).to.be.true
  ...
  it('should render Message with body when `text` prop was provided', () => {
    ...
    expect(
      wrapper.find('.message-body').exists(),
      '.message-body should be rendered when text prop given'
    ).to.be.true
  ...
  it('should render Messsage content children when `text` prop was not provided', () => {
    ...
    expect(
      wrapper.find('.message-body').exists(),
      '.message-body should be rendered when children prop given'
    ).to.be.true
